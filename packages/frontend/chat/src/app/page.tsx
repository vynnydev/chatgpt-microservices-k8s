...
import ClientHttp, { fetcher } from '@/main/http/http'
import { Chat, Message } from '@prisma/client'
import { useRouter, useSearchParams } from 'next/navigation'
import { FormEvent, useEffect, useLayoutEffect, useState } from 'react'
import { PlusIcon } from '@/presentation/components/PlusIcon'
import { MessageIcon } from '@/presentation/components/MessageIcon'
import { ArrowRightIcon } from '@/presentation/components/ArrowRightIcon'
import Image from 'next/image'
import { UserIcon } from '@/presentation/components/UserIcon'
import { marked } from 'marked'
import hljs from 'highlight.js'
import { LogoutIcon } from '@/presentation/components/LogoutIcon'
